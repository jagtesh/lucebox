...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q2_0] = {
        .type_name = "q2_0", .blck_size = QK2_0,
        .type_size = sizeof(block_q2_0), .is_quantized = true,
        .to_float = (ggml_to_float_t) dequantize_row_q2_0,
        .from_float_ref = (ggml_from_float_t) quantize_row_q2_0_ref,
    },
    [GGML_TYPE_PQ2_0] = {
        .type_name = "pq2_0", .blck_size = QK_PQ2_0,
        .type_size = sizeof(block_pq2_0), .is_quantized = true,
        .to_float = (ggml_to_float_t) dequantize_row_pq2_0,
        .from_float_ref = (ggml_from_float_t) quantize_row_pq2_0_ref,
    },
    [GGML_TYPE_PTQ1_0] = {
        .type_name = "ptq1_0", .blck_size = QK_PTQ1_0,
        .type_size = sizeof(block_ptq1_0), .is_quantized = true,
